...
template void constraintRzConCompute<double>(const GridParams<double>&, const FourierPlan<double>&, cumes::SpectralView<const double, cumes::PhysicalStateDomain>, ConstraintWorkspace<double>&, const double*);
