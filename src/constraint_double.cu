...
template void constraintDealiasBandpass<double>(const GridParams<double>&, const FourierPlan<double>&, const double*, const double*, const double*, double*, cudaStream_t);
