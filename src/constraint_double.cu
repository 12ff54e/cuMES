...
template void constraintCompute<double>(const GridParams<double>&, const cumes::RealSpaceStorage<double>&, const FourierPlan<double>&, const PreconWorkspace<double>&, ConstraintWorkspace<double>&, const double*, bool, cudaStream_t);
template void constraintComputeAxisym<double>(const GridParams<double>&, const cumes::RealSpaceStorage<double>&, const PreconWorkspace<double>&, ConstraintWorkspace<double>&, const double*, bool, cumes::AxisymmetricOperator<double>&, cudaStream_t);
