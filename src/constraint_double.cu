...
template void constraintCompute<double>(const DeviceParams<double>&, const cumes::RealSpaceStorage<double>&, const FourierPlan<double>&, const double*, const double*, ConstraintWorkspace<double>&, const double*, bool, cudaStream_t);
