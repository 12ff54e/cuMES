...
template void preconCompute<double>(const cumes::RealSpaceStorage<double>&, const FourierPlan<double>&, const GridParams<double>&, const RadialProfiles<double>&, const MetricWorkspace<double>&, PreconWorkspace<double>&, cudaStream_t);
