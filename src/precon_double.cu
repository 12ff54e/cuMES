...
template void preconCompute<double>(const cumes::RealSpaceStorage<double>&, const int*, const int*, const DeviceParams<double>&, const RadialProfiles<double>&, const MetricWorkspace<double>&, PreconWorkspace<double>&, cudaStream_t);
