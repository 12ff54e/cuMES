...
template void computeGeometry<float>(const cumes::RealSpaceStorage<float>&, const DeviceParams<float>&, const cumes::RadialProfileViews<float>&, MetricWorkspace<float>&, cudaStream_t, bool);
template void computeBaseGeometry<float>(const cumes::RealSpaceStorage<float>&, const DeviceParams<float>&, const cumes::RadialProfileViews<float>&, MetricWorkspace<float>&, cudaStream_t);
template void computeMagneticField<float>(const cumes::RealSpaceStorage<float>&, const DeviceParams<float>&, const cumes::RadialProfileViews<float>&, MetricWorkspace<float>&, cudaStream_t, bool);
