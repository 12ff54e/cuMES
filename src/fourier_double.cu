...
template void forwardDFT<double>(const FourierPlan<double>&, cumes::RealSpaceStorage<double>&, cumes::SpectralView<double, cumes::DecomposedResidualDomain>, const DeviceParams<double>&, const int*, const int*, const double*, const double*, const double*, const double*, cudaStream_t);
