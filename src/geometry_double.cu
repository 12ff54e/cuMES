...
template void computeGeometry<double>(const cumes::RealSpaceStorage<double>&, const DeviceParams<double>&, const RadialProfiles<double>&, MetricWorkspace<double>&, cudaStream_t, bool);
template void computeBaseGeometry<double>(const cumes::RealSpaceStorage<double>&, const DeviceParams<double>&, const RadialProfiles<double>&, MetricWorkspace<double>&, cudaStream_t);
template void computeMagneticField<double>(const cumes::RealSpaceStorage<double>&, const DeviceParams<double>&, const RadialProfiles<double>&, MetricWorkspace<double>&, cudaStream_t, bool);
