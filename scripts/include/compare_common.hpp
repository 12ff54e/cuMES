...
// Shared declarations for the standalone comparison tools. Define
// CUMES_COMPARE_COMMON_IMPLEMENTATION in one translation unit before including
// this file to emit the implementation, following the stb single-header style.
...
#ifdef CUMES_COMPARE_COMMON_IMPLEMENTATION
...
#endif  // CUMES_COMPARE_COMMON_IMPLEMENTATION
