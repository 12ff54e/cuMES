...
file(SHA256 "${artifact_dir}/cumes_coils.mjs" coils_javascript_hash)
file(SHA256 "${artifact_dir}/cumes_coils.wasm" coils_wasm_hash)
string(SHA256 asset_hash "${javascript_hash}${wasm_hash}${worker_hash}${coils_javascript_hash}${coils_wasm_hash}")
string(SUBSTRING "${asset_hash}" 0 16 asset_version)

file(READ "${html}" contents)
foreach(asset IN ITEMS browser_ui.js verification_worker.js residual_plot.js free_boundary.js coil_geometry.js equilibrium_view.js orbit_renderer.js boundary_editor.js)
